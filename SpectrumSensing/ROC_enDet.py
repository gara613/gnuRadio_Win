...
# Generated: Fri Aug  4 19:05:56 2017
##################################################
...
class ROC_enDet(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sigma_s = sigma_s = 5e-6
        self.sigma_n = sigma_n = 1.0000e-06
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'C:\\Users\\usuario\\Documents\\gnuRadio\\Misc\\SpectrumSensing\\expFile.dat', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, theta*sigma_s, 0)
        self.ROC_energy_block = ROC_energy_block.blk(N=N, thr=thr)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.ROC_energy_block, 0), (self.blocks_file_sink_0, 0))
